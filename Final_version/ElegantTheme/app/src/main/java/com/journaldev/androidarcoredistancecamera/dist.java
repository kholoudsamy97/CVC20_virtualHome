...
import com.example.kamran.eleganttheme.R;
...
public class dist extends AppCompatActivity implements Scene.OnUpdateListener {

/********************** calculating dimensions of customer's room using AR ******************/
    private static final double MIN_OPENGL_VERSION = 3.0;
    private static final String TAG = dist.class.getSimpleName();
